...
class GalaxiesControllerTest < ActionController::TestCase
  ...
  test "should create galaxy" do
    assert_difference('Galaxy.count') do
      post :create, galaxy: { info: @galaxy.info, name: @galaxy.name, posX: @galaxy.posX, posY: @galaxy.posY, posZ: @galaxy.posZ, rotX: @galaxy.rotX, rotY: @galaxy.rotY, rotZ: @galaxy.rotZ, size: @galaxy.size }
    end
  ...
  test "should update galaxy" do
    patch :update, id: @galaxy, galaxy: { info: @galaxy.info, name: @galaxy.name, posX: @galaxy.posX, posY: @galaxy.posY, posZ: @galaxy.posZ, rotX: @galaxy.rotX, rotY: @galaxy.rotY, rotZ: @galaxy.rotZ, size: @galaxy.size }
    assert_redirected_to galaxy_path(assigns(:galaxy))
  end
