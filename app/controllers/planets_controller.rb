class PlanetsController < ApplicationController
  ...
  before_action :get_planetary_systems, only: [:new, :edit, :update, :show]
  before_action :set_object_to_show, only: [:show, :edit, :new];
  ...
  # Use callbacks to share common setup or constraints between actions.
    ...
    def planet_params
      params.require(:planet).permit(:name, :info, :size, :rotX, :rotY, :rotZ, :posX, :posY, :posZ, :planetary_system_id)
    end
end
